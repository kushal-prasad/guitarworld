<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Acoustic Info.aspx.cs" Inherits="ttttt" %>
...
<li class="c2"><a target="" href="shop.aspx"><img src="images/datedm.png" height="19"/></a></li>
<li class="c2"><a target="" href="shop.aspx"><img src="images/price.png" height="19"/></a></li>
<li class="c3"><a target="" href="shop.aspx"><img src="images/alphdm.png" height="19"/></a></li>
                ...
                <asp:Repeater ID="Repeater3" runat="server" OnItemCommand="Repeater3_ItemCommand">
                    <ItemTemplate>
                        <div class="right11_1">
                            ...
                            <div class="right11_1_2">
                               Unit Price：<span style="color:#CC0000; font-size:14px;">$<strong><%# (Eval("shop_dol").ToString()) %></strong></span></div>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
        </div>
